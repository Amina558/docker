...
Telling docker to start a brand new container using a template called [hello-world]
1. docker: this is the command-line tool. It teels the OS that we are about to talk to the docker
